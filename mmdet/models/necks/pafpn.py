...
class PAFPN(FPN):
    ...
    def __init__(self,
      ...
      #  self.pacconv = PacConv2d(in_channels[0], out_channels, 3, padding=1)
       # self.conv_guide = ConvBNReLU(256, 256, 3, 2, 1)
    ...
    def forward(self, inputs):
        ...
        #inter_outs[0] = self.pacconv(inter_outs[0], feature_guide)
