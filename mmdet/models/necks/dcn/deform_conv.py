...
class DeformConvFunction(Function):
    ...
    def forward(ctx,
        ...
        ext_module.deform_conv_forward(
            input.contiguous(), weight, offset.contiguous(), output, ctx.bufs_[0], ctx.bufs_[1],
    ...
    def backward(ctx, grad_output):
        ...
        if ctx.needs_input_grad[0] or ctx.needs_input_grad[1]:
            ...
            ext_module.deform_conv_backward_input(
                input.contiguous(), offset.contiguous(), grad_output, grad_input.contiguous(),
                grad_offset.contiguous(), weight, ctx.bufs_[0], weight.size(3),
        ...
        if ctx.needs_input_grad[2]:
            ...
            ext_module.deform_conv_backward_parameters(
                ...
                input.contiguous(), offset.contiguous(), grad_output,
